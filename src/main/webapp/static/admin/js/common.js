...
layui.use(['form', 'jquery', 'laydate', 'layer', 'laypage', 'dialog',   'element'], function() {
	...
	$('.addBtn').click(function() {
		...
		if($(this).attr('data-title')){
			diaName=$(this).attr('data-title');
		}
		//将iframeObj传递给父级窗口,执行操作完成刷新
		parent.page(diaName, url, iframeObj, w = "700px", h = "620px");
		return false;
	...
	$('.addBtnXS').click(function() {
		...
		//将iframeObj传递给父级窗口,执行操作完成刷新
		parent.page(diaName, url, iframeObj, w = w, h = h);
		return false;
	...
	$('#table-list').on('click', '.edit-btn', function() {
		...
		//将iframeObj传递给父级窗口
		parent.page(diaName, url + "?id=" + id, iframeObj, w = "700px", h = "620px");
		return false;
	})
});
