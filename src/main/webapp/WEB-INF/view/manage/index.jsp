...
<html>
	...
	<body>
		<div class="main-layout" id='main-layout'>
			...
			<div class="main-layout-side" >
				<div class="m-logo">
				 ...
				 <ul class="layui-nav layui-nav-tree" id="leftNav-content" lay-filter="leftNav">
			...
			<div class="main-layout-container">
				...
				<div class="main-layout-header">
					...
					<ul class="layui-nav" lay-filter="rightNav">
					  <li class="layui-nav-item"><a href="javascript:;" data-url="http://localhost:7080/pageInterfaceController/toUserListIndex.do" data-id='4' data-text="邮件系统"><i class="iconfont">&#xe603;</i></a></li>
					  <li class="layui-nav-item">
					    <a href="javascript:;" data-url="admin-info.html" data-id='5' data-text="个人信息">超级管理员</a>
					  </li>
					  <li class="layui-nav-item"><a href="javascript:window.location.href='${basePath}/system/login.do';">退出</a></li>
					</ul>
				</div>
				<!--主体内容-->
				<div class="main-layout-body">
					...
					<div class="layui-tab layui-tab-brief main-layout-tab" lay-filter="tab" lay-allowClose="true">
					  <ul class="layui-tab-title">
					    <li class="layui-this welcome">后台1主页</li>
					  </ul>
					  <div class="layui-tab-content">
					    <div class="layui-tab-item layui-show" style="background: #f5f5f5;">
					    	<!--1-->
					    	<iframe src="${basePath}/loginController/welcomeIndex.do" width="100%" height="100%" name="iframe" scrolling="auto" class="iframe" framborder="0"></iframe>
					    	<!--1end-->
					    </div>
					  </div>
					</div>
		...
		<script type="text/javascript">
			var scope={
				link:'${basePath}/loginController/welcomeIndex.do'
			}
		</script>
		...
		<script type="text/javascript">
	        ...
	        //登陆页面
	        function getRbacInfo(){
	        	$.ajax({
	        	      url:basePath+'/rbacController/getUserRbacInfo.do',
	        		  type:'post',
	        		  dataType:'json',
	        		  async:false,
	        ...
	        function initRbac(rbac){
	        	$("#leftNav-content").html("");
	        	if(rbac.length>0){
	        		$.each(rbac, function(i, item){ 
			        	...
			        	if(i==0){
			        	   ...
			        	   if(url!=null){
							   html +=' <a href="javascript:;" data-id="'+item.id+'" data-url="'+url+'" ><i class="iconfont"> <img alt="" src="'+item.icon+'" style="width: 20px;height: auto;border-radius: 11px;"></i>'+item.name+'</a>';
			        	   }else{
							   html +=' <a href="javascript:;" data-id="'+item.id+'" ><i class="iconfont"><img alt="" src="'+item.icon+'" style="width: 20px;height: auto;border-radius: 11px;"></i>'+item.name+'</a>';
			        	   }
						   if(item.list.length>0){
							   html +=' <dl class="layui-nav-child">';
							   $.each(item.list, function(i, list){ 
								   var _url = list.url==''?null:list.url;
								   if(_url!=null){
									   html +=' <dd><a href="javascript:;" data-url="'+_url+'" data-id="'+list.id+'" data-text="'+list.name+'"><span class="l-line"></span>'+list.name+'</a></dd>';
								   }else{
									   html +=' <dd><a href="javascript:;" data-id="'+list.id+'" data-text="'+list.name+'"><span class="l-line"></span>'+list.name+'</a></dd>';
								   }
							   });
							   html +=' </dl>';
						   }
						   html +=' </li>';
						   $("#leftNav-content").append(html);
	        	    　	});
	        	}
	        }
		</script>
		...
		<script src="${basePath}/static/admin/js/main.js" type="text/javascript" charset="utf-8"></script>
	</body>
</html>
