...
<html>
	...
	<body>
						...
						<div class="panel-body">
							<div class="commentbox">
								<ul class="commentList">
								  <li class="item cl"> <a href="#"><i class="avatar size-L radius"><img alt="" src="${basePath}/img/avatar-default.jpg"></i></a>
		...
		<script src="${basePath}/static/admin/lib/echarts/echarts.js"></script>
		<script type="text/javascript">
			layui.use(['layer','jquery'], function(){
				...
				require.config({
				    paths: {
				        echarts: '${basePath}/static/admin/lib/echarts'
				    }
				});
				require(
				    [
